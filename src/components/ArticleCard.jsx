        ...
        <div className="p-5 bg-white">
          ...
          <div className="flex my-1 gap-5">
            <div className="w-3/4">
              ...
              <div>
                <ReactMarkdown className="flex max-w-none prose-pre:whitespace-pre-wrap text-base font-serif my-5 text-gray-800 overflow-hidden  sm:break-normal break-all text-ellipsis md:line-clamp-3 line-clamp-1">
                  {body}
                </ReactMarkdown>
              </div>
            </div>
